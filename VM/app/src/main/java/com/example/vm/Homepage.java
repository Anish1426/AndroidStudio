...
public class Homepage extends AppCompatActivity {
    Button transport,product,pcancel,psubmit,seller,sell_cancel,sell_submit,customer,pur_down,purchase;
    Dialog dialog;
    ...
    DatabaseReference reference,productReference,addSellerReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seller=findViewById(R.id.add_seller);
        ...
        customer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View view = getLayoutInflater().inflate(R.layout.add_customer,null);sell_gst = view.findViewById(R.id.sell_gst);
                sell_name=view.findViewById(R.id.sell_name);
                sell_address=view.findViewById(R.id.sell_address);
                sell_state  = view.findViewById(R.id.sell_state);
                sell_contact=view.findViewById(R.id.sell_contact);
                ...
                sell_submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(gst.equals("")||address.equals("")||state.equals("")||name.equals("")||contact.equals("")){
                            ...
                            Boolean insert_addcustomer=db.insert_customer(gst,name,address,state,contact);
                            if(insert_addcustomer==true){
                                Toast.makeText(Homepage.this,"Customer Added Successfully",Toast.LENGTH_SHORT).show();
                            }
                            else{
                                Toast.makeText(Homepage.this,"Customer Added Failed",Toast.LENGTH_SHORT).show();
                            }
